    ...
    return (
      <TelaCentro>
        ...
        <p className="mt-3 max-w-md text-lg text-slate-600">
          Recebemos seus dados com segurança. A Natália cuida de todo o resto e te
          avisa assim que sua apólice estiver emitida. <strong>Você não precisa fazer mais nada!</strong>
        </p>
